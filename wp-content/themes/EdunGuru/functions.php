...
wp_enqueue_script('custom-admin', get_theme_file_uri('/assets/js/custom.admin.js'), array(), null);
wp_enqueue_style('custom-admin', get_theme_file_uri('/assets/css/custom.admin.css'), array(), null);
...
function reorder_admin_menu($__return_true) {
    return array(
        'index.php', // Dashboard
        'edit.php?post_type=courses', // Pages 
        'edit.php?post_type=chapters', // Pages 
        'edit.php?post_type=topics', // Pages 
        'edit.php?post_type=questions', // Pages 
        'edit.php?post_type=notes', // Pages 
        'edit.php?post_type=tests', // Pages 
        'student-notes.php', // SN 
        'bookmarks.php', // B 
        'students-ask.php', // SA
