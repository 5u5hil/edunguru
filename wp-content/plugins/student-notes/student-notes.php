...
//        endif;
    ...
    public function add_menu_example_list_table_page() {
        add_menu_page('Student Notes', 'Student Notes', 'manage_options', 'student-notes.php', array($this, 'list_table_page'), 'dashicons-book', 1);
    }
    ...
    public function list_table_page() {
        $exampleListTable = new Make_A_Note();
 ...
 */
class Make_A_Note extends WP_List_Table {
    ...
    private function table_data() {
        ...
        global $wpdb;
        $data = $wpdb->get_results("SELECT * FROM wp_students_notes  ", ARRAY_A);
        $this->getCsv($data);
        return $data;
    }
