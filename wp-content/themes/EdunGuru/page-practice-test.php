      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="panel">
                <div class="panel-title"> <a class="collapsed" data-parent="#accordion5" data-toggle="collapse" href="#accordion5<?= $b ?>" aria-expanded="false"> <span class="open-sub"></span> 
				<strong>
						   <label for="<?= $chapter['id'] ?>" class="mb-0"><input type='checkbox' value="<?= $chapter['id'] ?>" id='<?= $chapter['id'] ?>' name="chapters[]"> <?= $chapter['title'] ?></label></strong>
				</a> 
				</div>
				<?php
				  ...
				  <div>
                      <ul>
                                    <?php foreach ($topics as $topic) { ?> 
                                        <li>
                                            <label for="<?= $topic['id'] ?>"><input type='checkbox' name='topicNames[]' value="<?= $topic['id'] ?>" id='<?= $topic['id'] ?>'> <?= $topic['title'] ?></label>
                                        </li>
                                    <?php }
                                    ?>
                                </ul>
